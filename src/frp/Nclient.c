...
char cvsid_host_client_Nclient_c[] = "$Header: /home/burschka/repository/XVision2/src/frp/Nclient.c,v 1.1.1.1 2008/01/30 18:43:46 burschka Exp $";
...
#if MT_ASYNC_WITH_SEMAPHORES
Semaphore *data_semaphore = NULL;
#endif
